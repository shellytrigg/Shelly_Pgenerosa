...
find /gscratch/srlab/strigg/data/Pgenr/FASTQS/leftover/EPI-*R1* \
...
-1 /gscratch/srlab/strigg/data/Pgenr/FASTQS/leftover/{}_R1_001_val_1.fq.gz \
-2 /gscratch/srlab/strigg/data/Pgenr/FASTQS/leftover/{}_R2_001_val_2.fq.gz \
