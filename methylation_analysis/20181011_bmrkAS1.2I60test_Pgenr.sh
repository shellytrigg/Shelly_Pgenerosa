...
cat - /gscratch/srlab/strigg/analyses/20181011/*.deduplication_report.txt \
grep 'Mapping\ efficiency\:\|removed' > /gscratch/srlab/strigg/analyses/20181011/EPI_mapping_dedup_summary.txt
