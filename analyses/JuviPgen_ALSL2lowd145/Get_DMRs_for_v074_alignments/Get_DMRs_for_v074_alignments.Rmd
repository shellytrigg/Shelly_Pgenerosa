---
title: "Get_DMRs_for_v074_alignments"
...
create file list
```{r}
file.list=c(dir("~/GitHub/Shelly_Pgenerosa/analyses/JuviPgen_ALSL2lowd145/Get_DMRs_for_v074_alignments/dedup_bams/",pattern = "_dedup.sorted.bam"))
file.list <- paste("~/GitHub/Shelly_Pgenerosa/analyses/JuviPgen_ALSL2lowd145/Get_DMRs_for_v074_alignments/dedup_bams/", file.list, sep = "")
...
li <- as.list(gsub("~/GitHub/Shelly_Pgenerosa/analyses/JuviPgen_ALSL2lowd145/Get_DMRs_for_v074_alignments/dedup_bams/EPI-","",file.list))
...
save(myobj, file = "~/GitHub/Shelly_Pgenerosa/data/20190807_myobj")


#load("~/GitHub/Shelly_Pgenerosa/data/20190807_myobj")
```
...
save(tiles, file = "~/GitHub/Shelly_Pgenerosa/data/20190807_tiles")

#load("~/GitHub/Shelly_Pgenerosa/data/20190807_tiles")
...
write.table(getData(hyper.l), "~/GitHub/Shelly_Pgenerosa/analyses/JuviPgen_ALSL2lowd145/Get_DMRs_for_v074_alignments/v074_ALvSL-L_hyperDMR.tsv", sep = "\t", quote = FALSE, row.names = FALSE)

# get hypo-methylated
hypo.l=getMethylDiff(myDiff.loci,difference=50,qvalue=0.01,type="hypo")
write.table(getData(hypo.l), "~/GitHub/Shelly_Pgenerosa/analyses/JuviPgen_ALSL2lowd145/Get_DMRs_for_v074_alignments/v074_ALvSL-L_hypoDMR.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
```