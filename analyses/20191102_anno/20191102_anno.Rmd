...
day10_GO_bkgd <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191109/all_day10_bkgd_0928GFF3.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE, quote = "", fill = FALSE)

day135_GO_bkgd <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191109/all_day135_bkgd_0928GFF3.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE, quote = "", fill = FALSE)

day145_GO_bkgd <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191109/all_day145_bkgd_0928GFF3.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE, quote = "", fill = FALSE)

amb_GO_bkgd <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191109/all_amb_bkgd_0928GFF3.txt", header = FALSE, sep = "\t", stringsAsFactors = FALSE, quote = "", fill = FALSE)

#remove extra columns
day10_GO_bkgd <- day10_GO_bkgd[,c(1:3,6)]
day135_GO_bkgd <- day135_GO_bkgd[,c(1:3,6)]
day145_GO_bkgd <- day145_GO_bkgd[,c(1:3,6)]
amb_GO_bkgd <- amb_GO_bkgd[,c(1:3,6)]
```
...
colnames(day10_GO_bkgd) <- c("chr", "start", "end","feature")

colnames(day135_GO_bkgd) <- c("chr", "start", "end","feature")

colnames(day145_GO_bkgd) <- c("chr", "start", "end","feature")

colnames(amb_GO_bkgd) <- c("chr", "start", "end","feature")
...
amb_GO_bkgd$group <- "amb"
day10_GO_bkgd$group <- "day10"
day135_GO_bkgd$group <- "day135"
day145_GO_bkgd$group <- "day145"
...
all_comparisons_bkgrd <- rbind(amb_GO_bkgd, day10_GO_bkgd, day135_GO_bkgd, day145_GO_bkgd)
