---
title: "MCmax25DMR_cov_in_0.75_Samples"
author: "Shelly Trigg"
date: "12/22/2019"
...
```{r}
amb_DMR <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191222/amb_AllTimes_DMR250bp_MCmax25_cov5x_rms_results_collapsed.tsv", header = TRUE,sep = "\t",stringsAsFactors = FALSE)
...
day10_DMR <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191222/day10_AllpH_DMR250bp_MCmax25_cov5x_rms_results_collapsed.tsv", header = TRUE,sep = "\t",stringsAsFactors = FALSE)
#loop through table and keep only lines where up to one sample contains NA for % methylation
...
day135_DMR <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191222/day135_AllpH_DMR250bp_MCmax25_cov5x_rms_results_collapsed.tsv", header = TRUE,sep = "\t",stringsAsFactors = FALSE)
#loop through table and keep only lines where up to one sample contains NA for % methylation
...
day145_DMR <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191222/day145_AllpH_DMR250bp_MCmax25_cov5x_rms_results_collapsed.tsv", header = TRUE,sep = "\t",stringsAsFactors = FALSE)
#loop through table and keep only lines where up to one sample contains NA for % methylation
