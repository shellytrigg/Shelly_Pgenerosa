---
title: "Oct29_MCmax50DMR_group_stats"
author: "Shelly Trigg"
date: "10/29/2019"
...
read in data
```{r}
oct24_MCmax50_DMRs_allAmb <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191023/amb_AllTimes_DMR250bp_MCmax50_cov5x_rms_results_filtered.tsv", header = TRUE, sep = "\t")
oct24_MCmax50_DMRs_day10 <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191023/day10_AllpH_DMR250bp_MCmax50_cov5x_rms_results_filtered.tsv", header = TRUE, sep = "\t")
oct24_MCmax50_DMRs_day135 <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191023/day135_AllpH_DMR250bp_MCmax50_cov5x_rms_results_filtered.tsv", header = TRUE, sep = "\t")
oct24_MCmax50_DMRs_day145 <- read.table("/Volumes/web/metacarcinus/Pgenerosa/analyses/20191023/day145_AllpH_DMR250bp_MCmax50_cov5x_rms_results_filtered.tsv", header = TRUE, sep = "\t")
...
oct24_MCmax50_DMRs_allAmb$ID <- paste(oct24_MCmax50_DMRs_allAmb$chr,":",oct24_MCmax50_DMRs_allAmb$start,"-",oct24_MCmax50_DMRs_allAmb$end, sep = "")
oct24_MCmax50_DMRs_allAmb$ID <- gsub("__.*__.*:",":",oct24_MCmax50_DMRs_allAmb$ID)

#for day 10 sample comparison

oct24_MCmax50_DMRs_day10$ID <- paste(oct24_MCmax50_DMRs_day10$chr,":",oct24_MCmax50_DMRs_day10$start,"-",oct24_MCmax50_DMRs_day10$end, sep = "")
oct24_MCmax50_DMRs_day10$ID <- gsub("__.*__.*:",":",oct24_MCmax50_DMRs_day10$ID)

#for day 135 sample comparison

oct24_MCmax50_DMRs_day135$ID <- paste(oct24_MCmax50_DMRs_day135$chr,":",oct24_MCmax50_DMRs_day135$start,"-",oct24_MCmax50_DMRs_day135$end, sep = "")
oct24_MCmax50_DMRs_day135$ID <- gsub("__.*__.*:",":",oct24_MCmax50_DMRs_day135$ID)

#for day 145 sample comparison

oct24_MCmax50_DMRs_day145$ID <- paste(oct24_MCmax50_DMRs_day145$chr,":",oct24_MCmax50_DMRs_day145$start,"-",oct24_MCmax50_DMRs_day145$end, sep = "")
oct24_MCmax50_DMRs_day145$ID <- gsub("__.*__.*:",":",oct24_MCmax50_DMRs_day145$ID)
...
day10_STACKED <- tidyr::gather(oct24_MCmax50_DMRs_day10[,7:19], "sample", "perc.meth",1:12)
...
write.csv(day10_aov_modelsumm, "day10_MCmax50_aov_modelsumm.csv", row.names = FALSE, quote = FALSE)
...
write.csv(chi_total, "day10_MCmax50_glm_Gammainv_modelsumm.csv", row.names = FALSE, quote = FALSE)
```

create matrix for day10 samples
```{r}
#subset out the data and order it
day10_m <- as.matrix(oct24_MCmax50_DMRs_day10[,c(11:14,7:8,15:16,9:10,17:18)])
rownames(day10_m) <- oct24_MCmax50_DMRs_day10$ID
```
...
jpeg("day10_MCmax50DMR_aov0.1_heatmap.jpg", width = 800, height = 1000)
...
jpeg("day10_MCmax50DMR_aov0.1_boxplots.jpg", width = 1000, height = 700)
...
ColSideColors <- cbind(pH = c(rep("cyan",4),rep("plum2",4),rep("magenta",4)))
jpeg("day10_MCmax50DMR_glm0.1_heatmap.jpg",width=800, height=1000)
...
jpeg("day10_MCmax50DMR_glm0.1_boxplots.jpg", width = 1000, height = 700)
