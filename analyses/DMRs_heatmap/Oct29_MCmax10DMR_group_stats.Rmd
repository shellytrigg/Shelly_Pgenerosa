...
#compare QQplots for first 10 models 
...
#there doesn't seem to be any difference between the different link options in the glm. ANOVA also seems to model the majority of well. So i am just going to go with an ANOVA despite the data violating the normality rule. 
